  ...
  <header>
    ...
    <div class="list_options">
      ...
      <div class="order_options">      
        <a class="order_button <?php the_active_param("order_by", "title", "active", true); ?>" href="<?php echo $urls['name']; ?>">Name</a>
        <a class="order_button <?php the_active_param("order_by", "date", "active"); ?>" href="<?php echo $urls['date']; ?>">Date</a>
      </div>
    </div>
  </header>
